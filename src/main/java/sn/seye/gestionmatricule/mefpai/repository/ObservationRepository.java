...
/**
 * Spring Data SQL repository for the Observation entity.
 */
@Repository
public interface ObservationRepository extends JpaRepository<Observation, Long> {
    ...
    @Query(
        value = "select distinct observation from Observation observation left join fetch observation.apprenant",
    ...
    @Query("select distinct observation from Observation observation left join fetch observation.apprenant")
    List<Observation> findAllWithToOneRelationships();

    @Query("select observation from Observation observation left join fetch observation.apprenant where observation.id =:id")
