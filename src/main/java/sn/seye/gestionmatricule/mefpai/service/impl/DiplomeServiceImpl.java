...
import sn.seye.gestionmatricule.mefpai.service.DiplomeService;
...
public class DiplomeServiceImpl implements DiplomeService {
    ...
    public Optional<Diplome> partialUpdate(Diplome diplome) {
        ...
        return diplomeRepository
            ...
            .map(existingDiplome -> {
                if (diplome.getNomDiplome() != null) {
                    existingDiplome.setNomDiplome(diplome.getNomDiplome());
                }
                if (diplome.getPhoto() != null) {
                    existingDiplome.setPhoto(diplome.getPhoto());
                }
                if (diplome.getPhotoContentType() != null) {
                    existingDiplome.setPhotoContentType(diplome.getPhotoContentType());
                }
