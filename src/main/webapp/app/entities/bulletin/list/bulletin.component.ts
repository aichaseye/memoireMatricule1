...
export class BulletinComponent implements OnInit {
  ...
  constructor(protected bulletinService: BulletinService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.bulletins = [];
  ...
  loadAll(): void {
    ...
    this.bulletinService
      ...
      .subscribe({
        next: (res: HttpResponse<IBulletin[]>) => {
          this.isLoading = false;
          this.paginateBulletins(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateBulletins(data: IBulletin[] | null, headers: HttpHeaders): void {
